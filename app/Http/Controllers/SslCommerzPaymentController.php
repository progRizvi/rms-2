...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data['cus_email'] = $request->address;
    ...
    public function success(Request $request)
    {
        ...
        } else if ($booking_details->payment_status == 'Processing' || $booking_details->payment_status == 'Complete') {
            /*
        ...
        session()->put('cart', []);
        toastr()->success('Success!', 'Order Successfully Completed');
