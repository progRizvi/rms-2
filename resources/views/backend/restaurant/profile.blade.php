        ...
        <div class="w-full text-white bg-main-color">
            <div x-data="{ open: false }"
                ...
                <div class="p-4 flex flex-row items-center justify-between">
                    <a href="#"
                        class="text-lg font-semibold tracking-widest uppercase rounded-lg focus:outline-none focus:shadow-outline">Restaurant
                        profile</a>
                ...
                <div class="w-full md:w-3/12 md:mx-2">
                    ...
                    <div class="bg-white p-3 border-t-4 border-green-400">
                        ...
                        <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">
                            {{ auth('restaurants')->user()->restaurant_name }}</h1>
                        <h3 class="text-gray-600 font-lg text-semibold leading-6">Owner at
                            {{ auth('restaurants')->user()->restaurant_name }}</h3>
                        <p class="text-sm text-gray-500 hover:text-gray-600 leading-6">
                            {{ auth('restaurants')->user()->description }}</p>
                        <ul
                            class="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                            <li class="flex items-center py-3">
                                <span>Status</span>
                                <span class="ml-auto">
                                    @if (auth('restaurants')->user()->status == 'approved')
                                        <span class="bg-green-500 py-1 px-2 rounded text-white text-sm">Approved</span>
                                    @elseif (auth('restaurants')->user()->status == 'rejected')
                                        <span class="bg-red-700 py-1 px-2 rounded text-white text-sm">Rejected</span>
                                    @else
                                        <span class="bg-yellow-700 py-1 px-2 rounded text-white text-sm">Pending</span>
                                    @endif
                                </span>
                            </li>
                            <li class="flex items-center py-3">
                    ...
                    <div class="bg-white p-3 shadow-sm rounded-sm">
                        ...
                        <div class="text-gray-700">
                            <div class="grid md:grid-cols-2 text-sm">
                                ...
                                <div class="grid grid-cols-2">
                                    <div class="px-4 py-2 font-semibold">Business Year</div>
